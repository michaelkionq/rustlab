...
fn print_help_list() {
    ...
    let categories = [
        ("Math",             &["abs","angle","real","imag","conj","cos","sin","acos","asin","atan","sqrt","exp","log","log10","log2"][..]),
        ("ML / Activation",  &["softmax","relu","gelu","layernorm"]),
        ("Array / Stats",    &["zeros","ones","linspace","rand","randn","randi",
                               "min","max","sum","cumsum","argmin","argmax","trapz",
                               "mean","std","histogram","savehist",
                               "len","length","numel","size"]),
        ("Matrix",           &["eye","transpose","diag","trace","reshape","repmat",
                               "horzcat","vertcat","rank"]),
        ("Linear Algebra",   &["dot","cross","outer","kron","norm","det","inv","expm","linsolve","eig","laguerre","legendre","factor","roots"]),
